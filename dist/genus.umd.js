(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('react'), require('glamorous')) :
	typeof define === 'function' && define.amd ? define(['exports', 'react', 'glamorous'], factory) :
	(factory((global['@taskanalytics/genus'] = {}),global.React,global.glamorous));
}(this, (function (exports,React,glamorous) {

var React__default = 'default' in React ? React['default'] : React;
glamorous = glamorous && glamorous.hasOwnProperty('default') ? glamorous['default'] : glamorous;
...
Button.propTypes = {
  ...
  compact: index$2.bool,
  inverted: index$2.bool,
  link: index$2.bool,
  primary: index$2.bool,
  primaryinverted: index$2.bool,
  warning: index$2.bool,
  spaceless: index$2.bool,
  to: index$2.string,
  type: index$2.oneOf(['button', 'submit'])
};
Button.defaultProps = {
  type: 'button'
};
  ...
  if (hasArray) {
    var _ret = function () {
      ...
      var flattened = Object.keys(style).reduce(function (o, key) {
        o[key] = Array.isArray(style[key]) ? style[key].join('; ' + (0, index$7.processStyleName)(key) + ': ') : style[key];
        return o;
      }, {});
      // todo - 
...
function prefixes(node) {
  return (0, _objectAssign2.default)({}, node, { style: index$9(node.style) });
}
});
...
function toCSS(_ref) {
  ...
  return result.selector + '{' + (0, index$7.createMarkupForStyles)(result.style) + '}';
}
  ...
  if (!inserted[spec.id]) {
    (function () {
      var inner = Object.keys(spec.keyframes).map(function (kf) {
        ...
        return result.name + '{' + (0, index$7.createMarkupForStyles)(result.style) + '}';
      }).join('');
...
function insertFontFace(spec) {
  if (!inserted[spec.id]) {
    styleSheet.insert('@font-face{' + (0, index$7.createMarkupForStyles)(spec.font) + '}');
    inserted[spec.id] = true;
  }
}
...
var index_18 = index$3.css;

var swiftOut = 'cubic-bezier(0, 0, 0.1, 1)';

var progressFillUp = index_18.keyframes({
  from: { width: 0 }
});
var progressLabel = index_18.keyframes({
  from: {
    opacity: 0,
...
ProgressBar.propTypes = {
  value: index$2.number.isRequired,
  min: index$2.number,
  max: index$2.number,
  baseline: index$2.bool,
  light: index$2.bool,
  empty: index$2.bool
};
...
Number.propTypes = {
  value: index$2.oneOfType([index$2.string, index$2.number]).isRequired,
  description: index$2.string.isRequired,
  size: index$2.oneOf(['small', 'large']),
  sup: index$2.string
};
...
index$5(ReactPureComponent.prototype, ReactComponent.prototype);
...
ReactElement.cloneElement = function (element, config, children) {
  ...
  var props = index$5({}, element.props);
...
var createClass$1 = factory_1$2(Component$1, isValidElement$1, ReactNoopUpdateQueue_1);
...
if (process.env.NODE_ENV !== 'production') {
  ...
  __spread = function () {
    ...
    return index$5.apply(null, arguments);
  };
...
var _react = ( react$2 && react ) || react$2;
...
var index$11 = withProps(function (props) {
  return {
    sup: '%'
  };
})(Number);

var pieFilUp = index_18.keyframes({
...
//# sourceMappingURL=genus.umd.js.map
